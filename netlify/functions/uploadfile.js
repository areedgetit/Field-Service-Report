exports.handler = async function (event, context) {
  ...
  try {
    ...
    if (event.httpMethod === 'POST') {
      ...
      const uploadUrl = `https://graph.microsoft.com/v1.0/drives/${driveId}/root:/Mechanical/Machine (Reports, photos, inspections, Live Data)/Field Service/Reports/${fileName}:/content`;
